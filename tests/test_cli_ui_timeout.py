...
def test_cmd_build_ui_timeout_returns_nonzero(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr(cli, "musicbrainz_get_release_group_details_result", lambda *args, **kwargs: missing)
    monkeypatch.setattr(cli, "_wikipedia_overview_result", lambda *args, **kwargs: missing)
